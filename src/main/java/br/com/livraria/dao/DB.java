...
public class DB {
    public static void main(String[] args) {
        ...
        DAO<Livro, Integer> livrosDAO = new DAO<Livro,Integer>(Livro.class, manager);
        DAO<Autor, Integer> autorDAO = new DAO<Autor,Integer>(Autor.class, manager);
        DAO<User, Integer> userDAO = new DAO<User,Integer>(User.class, manager);
